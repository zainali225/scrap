...
import { getCricketHdIframe, getFreeStreamsIframe } from '@services/helper';
...
class Streaming extends Component {
    ...
    componentDidMount = async () => {
        ...
        // let iframe = getFreeStreamsIframe(html).replace(/\s/g, "%20")
        // console.log('iframe: ', iframe);
 
        // this.setState({ loading: false, iframe: iframe })
        this.setState({ loading: false, iframe: html })
    };
        ...
        return (
            ...
            loading ?
                ...
                <WebView
                    ...
                    source={{ html: iframe }} style={{ width: "100%", height: "100%" }}
